...
export type ProjectMemberWhereInput = {
  ...
  invitedAt?: Prisma.DateTimeFilter<"ProjectMember"> | Date | string
...
export type ProjectMemberScalarWhereWithAggregatesInput = {
  ...
  invitedAt?: Prisma.DateTimeWithAggregatesFilter<"ProjectMember"> | Date | string
...
export type ProjectMemberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"role" | "invitedAt" | "joinedAt" | "projectId" | "userId", ExtArgs["result"]["projectMember"]>
...
export interface ProjectMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const projectMemberWithInvitedAtOnly = await prisma.projectMember.findMany({ select: { invitedAt: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProjectMembers and only return the `invitedAt`
   * const projectMemberWithInvitedAtOnly = await prisma.projectMember.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProjectMembers and only return the `invitedAt`
   * const projectMemberWithInvitedAtOnly = await prisma.projectMember.updateManyAndReturn({
   *   select: { invitedAt: true },
   *   where: {
   *     // ... provide filter here
   *   },
